<template>
  <div class="bg-white">
    <header>
      <div class="container mx-auto px-6 py-3">
        <div class="flex items-center justify-between">
          ...
          <div
            class="w-full text-gray-700 md:text-center text-2x1 font-semibold"
          >
            Brand
          </div>
        ...
        <nav class="sm:flex sm:justify-center sm:items-center mt-4">
          <div class="flex col sm:flex-row">
            <a
              href="/"
              class="mt-3 text-gray-600 hover:outline-none sm:mx-3 sm:mt-0"
            >
              Home
            </a>
            <a
    ...
    <footer class="bg-gray-200">
      ...
      >
        <a href="/" class="text-x1 font-bold text-gray-500 hover:text-gray-400">
          <p class="py-2 text-gray-500 sm:py-0">All right reserved</p>
        </a>
      </div>
    </footer>
  </div>
